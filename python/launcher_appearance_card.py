...
class TerminalAppearanceCard(CleanRoundedCard):
    def __init__(self, master, *, theme, scale, callbacks):
        ...
        opacity_row = tk.Frame(body, bg=self.panel_bg)
        opacity_row.grid(row=2, column=0, sticky="ew", pady=(scale(5), 0))
        ...
        actions = tk.Frame(body, bg=self.panel_bg)
        actions.grid(row=3, column=0, sticky="ew", pady=(scale(6), 0))
